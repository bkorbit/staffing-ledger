...
### Chart categorical ramp (department series — a confirmed exception, like the pipeline ramp)
Seven hues for the one chart that stacks many equal categories — Project Hours' hours-per-week-by-department — and nothing else: `--cat-1` `#48a278` (Muted Ledger Green, leads), `--cat-2` `#4e7bc0` blue, `--cat-3` `#c05a86` magenta, `--cat-4` `#5b5fc4` indigo, `--cat-5` `#2196a8` teal, `--cat-6` `#7d8f2f` olive, `--cat-7` `#9a5fb5` plum; `--cat-other` `#b5b5b5` for the fold. Admitted 8 Sep 2026 after the brand-only stack proved illegible: the three brand greens sit within ΔE 11 of each other, which fails even for full colour vision. The **order is the mechanism**, not taste — it alternates cool/warm and light/dark so adjacent segments clear ΔE≥15 normal, ≥8 for every colour-vision deficiency, ≥3:1 on white (dataviz validator; orderings enumerated, this is one of the few that pass). Seven is a hard ceiling: no brand-compatible eighth hue passes, so an eighth series folds to Other. Colour follows the department name company-wide (headcount order, or an explicit pin), never a project's own ranking. Rust, amber, gold and grey are excluded on purpose — they carry meanings.
